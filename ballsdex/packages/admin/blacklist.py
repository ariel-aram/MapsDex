...
class Blacklist(app_commands.Group):
    ...
    async def blacklist_add(
        ...
        try:
            ...
            return {"summary_message": f"Blacklisted user {user} ({user.id}) for reason: {reason}"}
    ...
    async def blacklist_remove(
        ...
        try:
            ...
            return {"summary_message": f"Removed blacklist for user {user} ({user.id}). Reason: {reason}"}
...
class BlacklistGuild(app_commands.Group):
    ...
    async def blacklist_add_guild(
        ...
        try:
            ...
            return {"summary_message": f"Blacklisted guild {guild} ({guild.id}) for reason: {reason}"}
    ...
    async def blacklist_remove_guild(
        ...
        try:
            ...
            return {"summary_message": f"Removed blacklist for guild {guild} ({guild.id}). Reason: {reason}"}
